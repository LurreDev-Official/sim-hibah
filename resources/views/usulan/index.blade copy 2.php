        ...
        <div class="post d-flex flex-column-fluid" >
            <div id="kt_content_container" class="container-xxl">
                <div class="card-header card-header-stretch">
                    <h3 class="card-title">Kelola Usulan </h3>
                    <div class="card-toolbar">
                        <ul class="nav nav-tabs nav-line-tabs nav-stretch fs-6 border-0">
                            <li class="nav-item">
                                <a class="nav-link active" data-bs-toggle="tab" href="#kt_tab_usulan">Usulan</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" data-bs-toggle="tab" href="#kt_tab_reviewer">Review</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" data-bs-toggle="tab" href="#kt_tab_revision">Revision</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" data-bs-toggle="tab" href="#kt_tab_approved">Approved</a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="tab-content" id="myTabContent">
                    <!-- Tab Usulan Content -->
                    <div class="tab-pane fade show active" id="kt_tab_usulan" role="tabpanel">
                         ...
                         <!-- Tab Reviewer Content -->
            <div class="tab-pane fade" id="kt_tab_reviewer" role="tabpanel">
                <p>Konten untuk Tab Reviewer. Masukkan konten yang relevan di sini.</p>
            </div>

            <!-- Tab Revision Content -->
            <div class="tab-pane fade" id="kt_tab_revision" role="tabpanel">
                <p>Konten untuk Tab Revision. Masukkan konten yang relevan di sini.</p>
            </div>

            <!-- Tab Approved Content -->
            <div class="tab-pane fade" id="kt_tab_approved" role="tabpanel">
                <p>Konten untuk Tab Approved. Masukkan konten yang relevan di sini.</p>
            </div>
