        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div id="kt_content_container" class="container-xxl">
                ...
                <div class="card">
                    ...
                    <!--end::Card header-->
                    <div class="card-body">
                        <h4>Tampilkan PDF Laporan Kemajuan</h4>
                        <iframe src="{{ asset('storage/' . $laporanKemajuan->dokumen_laporan_kemajuan) }}" width="100%" height="600px" frameborder="0"></iframe>
                    </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="mb-5">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <form id="penilaianForm" action="{{ route('form-penilaian.laporan-kemajuan.store', ['id' => $laporanKemajuan->id]) }}" method="POST">
                                        @csrf
