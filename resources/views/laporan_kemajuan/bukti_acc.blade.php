...
<head>
    ...
    <title>Bukti ACC - Laporan Kemajuan</title>
    <style>
        body {
...
<body>
    ...
    <h1>Bukti ACC Laporan Kemajuan</h1>

    <table style="width: 100%; text-align: center; border-collapse: collapse;">
        <tr>
            <th>Judul Laporan Kemajuan</th>
            <td>{{ $laporanKemajuan->usulan->judul_usulan }}- {{ $laporanKemajuan->usulan->ketuaDosen->user->name }} </td>
