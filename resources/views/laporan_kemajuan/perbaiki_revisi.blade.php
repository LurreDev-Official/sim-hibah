            ...
            <div class="card">
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        <div class="d-flex justify-content-end">
                            <a class="btn btn-primary" href="{{ url('laporan-kemajuan/penelitian') }}">Kembali</a>
                        </div>
                    </div>
                    <!--end::Card toolbar-->
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="mb-4">
                        ...
                        @if(isset($laporankemajuanPerbaikan) && $laporankemajuanPerbaikan->dokumen_usulan)
                            <!-- File View Button -->
                            <div class="mb-3">
                        ...
                        <!-- Upload File Form -->
                        <form action="{{ route('laporan-kemajuan.simpanPerbaikan', ['id' => $laporanKemajuan->id]) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                        ...
                        <div class="modal-dialog modal-fullscreen"> <!-- Fullscreen Modal -->
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    @if(pathinfo($laporanKemajuanPerbaikan->dokumen_usulan, PATHINFO_EXTENSION) === 'pdf')
                                        <embed src="{{ asset('storage/' . $laporanKemajuanPerbaikan->dokumen_usulan) }}" type="application/pdf" width="100%" height="500px" />
                                    @else
                                        <p>File tersedia untuk diunduh:</p>
                                        <a href="{{ asset('storage/' . $laporankemajuanPerbaikan->dokumen_usulan) }}" target="_blank" class="btn btn-success">
