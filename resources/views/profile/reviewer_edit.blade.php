                            ...
                            <div class="card-body border-top p-9">
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8 fv-row">
                                        <input id="nidn" type="text" class="form-control form-control-lg form-control-solid @error('nidn') is-invalid @enderror" name="nidn" value="{{ old('nidn', $reviewer->nidn) }}" required>
                                        @error('nidn')
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8 fv-row">
                                        <select id="fakultas" name="fakultas" class="form-control form-control-lg form-control-solid">
                                            ...
                                            <option value="Fakultas Agama Islam" {{ old('fakultas', $reviewer->fakultas) == 'Fakultas Agama Islam' ? 'selected' : '' }}>Fakultas Agama Islam</option>
                                            <option value="Fakultas Teknik" {{ old('fakultas', $reviewer->fakultas) == 'Fakultas Teknik' ? 'selected' : '' }}>Fakultas Teknik</option>
                                            <option value="Fakultas Teknologi Informasi" {{ old('fakultas', $reviewer->fakultas) == 'Fakultas Teknologi Informasi' ? 'selected' : '' }}>Fakultas Teknologi Informasi</option>
                                            <option value="Fakultas Ekonomi" {{ old('fakultas', $reviewer->fakultas) == 'Fakultas Ekonomi' ? 'selected' : '' }}>Fakultas Ekonomi</option>
                                            <option value="Fakultas Ilmu Pendidikan" {{ old('fakultas', $reviewer->fakultas) == 'Fakultas Ilmu Pendidikan' ? 'selected' : '' }}>Fakultas Ilmu Pendidikan</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                document.addEventListener('DOMContentLoaded', function () {
                                    ...
                                    const selectedFakultas = "{{ old('fakultas', $reviewer->fakultas) }}";
                                    const selectedProdi = "{{ old('prodi', $reviewer->prodi) }}";
