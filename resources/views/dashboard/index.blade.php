                                                ...
                                                <div class="card-body">
                                                    <div class="list-group">
                                                        @foreach ($notifikasi as $notif)
                                                            <div
                                                                class="list-group-item list-group-item-action mb-2 border border-2 shadow-sm">
                                        ...
                                        <div class="d-flex align-items-sm-center mb-7">
                                            ...
                                            <div class="d-flex align-items-center flex-row-fluid flex-wrap">
                                                <div class="flex-grow-1 me-2">
                                                    <a href="#"
                                                        class="text-gray-800 text-hover-primary fs-6 fw-bolder">Kuota
                                                        Proposal</a>
                                ...
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <h6>5. Skoring SINTA 200&gt; Menjadi ketua pengusul (pengembangan kedepan tahun
                                                2026):
                                            </h6>
