        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            <div class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">
                    Grafik Usulan Berdasarkan Prodi
                    ...
                    <div class="col-12">
                        <div class="card card-xl-stretch mb-5 mb-xl-8">
                            <div class="card-header border-0 pt-5">
                                <h3 class="card-title">Grafik Usulan Berdasarkan Prodi</h3>

                                <!-- Form Filter Tahun -->
                                <form method="POST" action="{{ route('grafik-usulan.index') }}" class="d-flex align-items-center">
                                    @csrf
                                    ...
                                    <select name="tahun" id="tahun" class="form-control w-25">
                                        @php
                                            ...
                                            $endYear = $currentYear + 3;    // End year: 2 years after the current year
                                        @endphp
